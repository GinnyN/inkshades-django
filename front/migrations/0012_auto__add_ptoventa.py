...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PtoVenta'
        db.create_table(u'front_ptoventa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('ciudad', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'front', ['PtoVenta'])


    def backwards(self, orm):
        # Deleting model 'PtoVenta'
        db.delete_table(u'front_ptoventa')
