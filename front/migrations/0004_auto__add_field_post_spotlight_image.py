...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.spotlight_image'
        db.add_column(u'front_post', 'spotlight_image',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.spotlight_image'
        db.delete_column(u'front_post', 'spotlight_image')
