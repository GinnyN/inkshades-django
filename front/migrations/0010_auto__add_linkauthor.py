...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkAuthor'
        db.create_table(u'front_linkauthor', (
        ...
        db.send_create_signal(u'front', ['LinkAuthor'])


    def backwards(self, orm):
        # Deleting model 'LinkAuthor'
        db.delete_table(u'front_linkauthor')
